...
abstract class LocationRepository {
  ...
  Future<({List<Location>? data, AppError? error})> searchLocations(String query);
  
  Future<({List<Location>? data, AppError? error})> getFavoriteLocations();
  
  Future<({bool success, AppError? error})> addFavoriteLocation(Location location);
  
  Future<({bool success, AppError? error})> removeFavoriteLocation(Location location);
